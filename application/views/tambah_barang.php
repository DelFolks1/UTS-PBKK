            ...
            <?= form_open_multipart('data_barang/tambah_barang')  ?>
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input class="form-control" id="exampleInputEmail1" placeholder="" type="text" name="nama">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" id="exampleInputEmail1" placeholder="Stok Barang" type="text" name="stok">
                </div>
                <div class="form-group">
